import { Promotion, AppConfig } from './types';
...
export const DEFAULT_CONFIG: AppConfig = {
  salesPhone: '526635097802',
  heroSlides: [
    {
      id: '1',
      image_url: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?auto=format&fit=crop&q=80&w=1200',
      title: 'izzi 100 Megas',
      subtitle: 'La mejor conexión para tu hogar con izzi tv incluido.'
    },
    {
      id: '2',
      image_url: 'https://images.unsplash.com/photo-1593305841991-05c297ba4575?auto=format&fit=crop&q=80&w=1200',
      title: 'Disney+ Incluido',
      subtitle: 'Disfruta de tus series y películas favoritas con izzi.'
    },
    {
      id: '3',
      image_url: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&q=80&w=1200',
      title: 'izzi Móvil',
      subtitle: 'Lleva tu conexión a todos lados con la red 4.5G.'
    }
  ]
};
